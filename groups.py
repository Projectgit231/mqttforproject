...
#Подписанные. Список содержит 4 элемента, по одному на каждого члена списка Data. Каждый элемент(список) заполняется номерами(айди) пользователей, которым приходит сообщение,  когда член списка проходит в техникум.  
subscribed = [
    [],
    [],
    [],
